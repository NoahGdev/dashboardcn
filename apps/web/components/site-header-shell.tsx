...
/**
 * The header chrome from getopen.so: a full-width bar at the top of the page
 * that, once the visitor scrolls, condenses into a narrower frosted pill.
 */
